...
module.exports = {
  ...
  alias: {
    /* 各种目录 */
    iconfontDir: path.resolve(dirVars.resourceDir, 'iconfont/'),
    ...
    /* less */
    lessDir: path.resolve(dirVars.resourceDir, 'less'),
    ...
    /* logic */
    cm: path.resolve(dirVars.commonDir, 'common.module'),
    cp: path.resolve(dirVars.commonDir, 'common.page'),
