...
pageArr.forEach((page) => {
    const htmlPlugin = new HtmlWebpackPlugin({
        ...
        template:    fs.existsSync(path.resolve(dirVars.entriesDir, `./${page}/template.ejs`))?path.resolve(dirVars.entriesDir, `./${page}/template.ejs`):path.resolve(dirVars.entriesDir, `./${page}/page.html`),
